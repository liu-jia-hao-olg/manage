...
<div class="Affairs">
    <div class="aff">
        ...
        <div class="zhong">
            <div class="zhong-wen">
                <p>温馨提示：可以点击【外卖分类】和【外卖商品】进行添加或修改</p>
            </div>
            <el-table :data="tableData" style="width: 100%" :row-class-name="tableRowClassName">
                <el-table-column prop="date" label="编号">
                </el-table-column>
                <el-table-column prop="tu" label="图片">
                    <template slot-scope="scope">
                        <img :src="scope.row.tu" min-width="50" height="50" />
                    </template>
                </el-table-column>
                <el-table-column prop="name" label="门店名称">
                </el-table-column>
                <el-table-column prop="address" label="服务">
                </el-table-column>
            </el-table>
            <div class="block">
...
export default {
    ...
    data() {
        return {
            ...
            tableData: [{
                date: '1001',
                tu: require("../Customized/img/3.jpg"),
                name: '花生米科技公司总部',
                address: '服务（5）',
            }, {
                date: '1001',
                ...
                date: '1001',
                tu: require("../Customized/img/4.jpg"),
                name: '花生米科技公司（天河店）',
                address: '服务（5）',
            }]
        };
